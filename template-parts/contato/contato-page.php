		...
		<ul class="Section-items u-displayFlex u-flexDirectionColumn u-flexJustifyContentCenter u-flexSwitchRow u-sizeFull">
			...
			<li class="Section-items-item--geocron u-paddingHorizontal--inter u-paddingLeft">
				...
				<div class="Section-items-item-content">
					...
					<p class="Section-items-item-content-resume u-paddingHorizontal--inter--half">contato@geocron.com.br</p>
					<p class="Section-items-item-content-resume u-paddingBottom--inter--half">Av. Isabel Bezerra, 330 - Ancuri<br>Fortaleza-CE</p>
					<figure class="Section-items-item-content-figure u-onlyDesktop">
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/mapa-contato.png">
					</figure>
					<figure class="Section-items-item-content-figure  u-displayFlex u-flexJustifyContentCenter  u-onlyMobile">
