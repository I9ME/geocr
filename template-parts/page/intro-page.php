		 ...
		 <form class="Form Form--style1">
			<fieldset class="Form-fieldset">
				<div class="Form-line u-displayFlex u-flexDirectionColumn u-flexJustifyContentCenter u-flexSwitchRow u-flexFlowWrap">
					<div class="Form-row u-marginBottom--inter--half u-overflowHidden u-positionRelative u-displayFlex u-flexDirectionColumn u-flexSwitchRow is-animating u-borderRadius10">
						<input type="text" name="mail" class="u-borderRadius10 Form-input Form-input--text Form-border--0 u-size24of24" placeholder="Seu e-mail">
						<input type="submit" value="ENVIAR" name="orcamento_submit" class="Button Button--border Button--background ButtonLink u-displayInlineFlex u-flexDirectionRow u-flexAlignItemsCenter u-justifyContentCenter Button--mediumSize hover is-animating u-size10of24 u-borderRadius10">
					</div>
				</div>
			</fieldset>
		</form> -->
